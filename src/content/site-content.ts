...
import { parkGeneralGalleryImages } from "@/data/unit-gallery-assets";
...
const siteCopyByLocale: Record<Locale, SiteCopy> = {
  en: {
    ...
    heroText: "Explore the buildings, review the available homes, and contact the sales team for current availability.",
  ...
  bg: {
    ...
    heroText: "Разгледайте сградите, вижте свободните жилища и се свържете с търговския екип за актуална наличност.",
    contactEmail: "sales@pautalia.com",
    contactPhone: "+359 877 909 010",
  ...
  en: [
    {
      ...
      copy: "The buildings combine practical layouts, private outdoor space where available, and a quieter residential setting.",
      ctaLabel: "See the buildings",
      href: "/buildings",
  ...
  bg: [
    {
      ...
      copy: "Сградите съчетават практични разпределения, частни външни пространства при избрани жилища и по-спокойна жилищна среда.",
      ctaLabel: "Виж сградите",
      href: "/buildings",
      image: "/assets/buildings/residence/gallery/exterior-front.jpg",
  ...
  en: [
    {
      ...
      excerpt: "Review the current selection in the buildings and continue directly to the available homes inside.",
      href: "/buildings",
      image: "/assets/buildings/residence/gallery/exterior-front.jpg",
    ...
    },
    {
      ...
      href: "/location",
      image: "/assets/buildings/residence/gallery/balcony-view.jpg",
  ...
  bg: [
    {
      ...
      excerpt: "Разгледайте текущата селекция в сградите и преминете директно към свободните жилища вътре.",
      href: "/buildings",
      image: "/assets/buildings/residence/gallery/exterior-front.jpg",
...
const galleryAssetsByLocale: Record<Locale, GalleryAsset[]> = {
  en: [
    ...
    },
    {
      ...
      caption: "Exterior render from Park, shown as part of the wider Pautalia visual library.",
    },
    {
      id: "gallery-7",
      title: "Park living space",
      categoryLabel: "Interior",
      image: parkGeneralGalleryImages.living,
      caption: "Living area render from one of the Park apartments.",
    },
    {
      id: "gallery-8",
      title: "Private yard",
      ...
      caption: "Ground-floor Park apartment render with private yard connection.",
    },
    {
      id: "gallery-9",
      title: "Upper balcony",
      ...
      caption: "Balcony render from an upper-floor Park apartment.",
    },
  ],
  bg: [
    {
    ...
    {
      id: "gallery-6",
      title: "Екстериор Парк",
      categoryLabel: "Екстериор",
      image: parkGeneralGalleryImages.exterior,
      caption: "Екстериорен рендер от Парк като част от общата визуална библиотека на Pautalia.",
    },
    {
      id: "gallery-7",
      title: "Дневна зона в Парк",
      categoryLabel: "Интериор",
      image: parkGeneralGalleryImages.living,
      caption: "Рендер на дневна зона от един от апартаментите в Парк.",
    },
    {
      id: "gallery-8",
      title: "Частен двор",
      categoryLabel: "Външно пространство",
      image: parkGeneralGalleryImages.yard,
      caption: "Рендер на апартамент на партерно ниво в Парк с връзка към частен двор.",
    },
    {
      id: "gallery-9",
      title: "Балкон на горно ниво",
      categoryLabel: "Външно пространство",
      image: parkGeneralGalleryImages.balcony,
      caption: "Рендер на балкон от апартамент на горен етаж в Парк.",
    },
  ],
};
